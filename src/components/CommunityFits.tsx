  ...
  const fits: CommunityFit[] = [
    {
      ...
      likes: '1.2k',
      product_name: 'Argentina & Boca Retro Squad',
      price: 'From €95.99',
      tag: 'TAGGED FIT',
      cta_text: 'SHOP',
      cta_type: 'shop',
    ...
    },
    {
      ...
      likes: '2.8k',
      product_name: "Brazil Ronaldo #9 Long Sleeve",
      price: '€189.99',
      tag: 'STREET STYLE',
      cta_text: 'SHOP',
      cta_type: 'shop'
    },
    {
      ...
      likes: '3.5k',
      product_name: 'AC Milan bwin Era',
      price: '€98.99',
      tag: 'FABRIC DETAIL',
      cta_text: 'VIEW',
      cta_type: 'view'
    },
    {
      ...
      likes: '4.2k',
      product_name: 'Brazil & Milan Double Fit',
      price: 'From €98.99',
      tag: 'DOUBLE FIT DROP',
      cta_text: 'SHOP PAIR',
      cta_type: 'shop'
    },
    {
      ...
      likes: '2.1k',
      product_name: 'Argentina 94 Retro #10',
      price: '€99.99',
      tag: 'BARCELONA STREETS',
      cta_text: 'SHOP',
      cta_type: 'shop'
    }
  ];
